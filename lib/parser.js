...
class Parser extends EventEmitter {
    parseLine(line) {
        ...
        if (line.match(/^Initialize engine version/)) {
            ...
            result = ["action_start", {type: "attack", source: {id: parseInt(id), card_id: cardId, player_id: parseInt(playerId)}, target: {id: parseInt(targetId), card_id: targetCardId, player_id: parseInt(targetPlayerId)}}];
            ...
            result = ["action_start", {type: "power", source: {id: parseInt(id), card_id: cardId, player_id: parseInt(playerId)}, target: {id: parseInt(targetId), card_id: targetCardId, player_id: parseInt(targetPlayerId)}}];
            ...
            result = ["action_start", {type: "power", source: {id: parseInt(id), card_id: cardId, player_id: parseInt(playerId)}, target: {id: parseInt(targetId)}}];
            ...
            result = ["action_start", {type: "play", source: {id: parseInt(id), card_id: cardId, player_id: parseInt(playerId)}, target: {id: parseInt(targetId)}}];
        }
